...
const CartPayment = () =>{
    ...
    //Stripe payment
    const stripePromise = loadStripe(`${process.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY!}');
    ...
    return(
        <div className="flex flex-col gap-4">
            ...
            <p className="flex items-center justify-between px-2 font-semibold">Total Price: {" "}
                ...
                <button onClick={handleCheckout} className="w-full h-10 text-sm font-semibold bg-amazon_blue bg-opacity-100 text-white rounded-lg
                hover:bg-amazon_yellow hover:text-black duratiom-300">
            Proceed to Checkout
          </button>
